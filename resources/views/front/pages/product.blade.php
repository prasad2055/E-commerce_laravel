                    ...
                    <div class="col-12 sidebar h-100">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                <button class="btn btn-outline-dark add-to-cart" type="button" data-id="{{ $product->id }}"><i class="fas fa-cart-plus me-2"></i>Add to cart</button>
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <div class="row h-100">
                                    <div class="col-12 p-0 mb-3">
                                        <a href="{{ route('front.pages.product', [$similar->id]) }}">
                                            <img src={{ url("public/images/{$similar->thumbnail}") }} class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        @empty($similar->discounted_price)
                                    ...
                                    <div class="col-12 mb-3 align-self-end">
                                        <button class="btn btn-outline-dark add-to-cart" type="button" data-id="{{ $similar->id }}"><i class="fas fa-cart-plus me-2"></i>Add to cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
